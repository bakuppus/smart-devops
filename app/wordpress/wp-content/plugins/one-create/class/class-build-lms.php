...
//set defaults
update_blog_option($id, 'settings', get_blog_option(1, 'settings'));
update_blog_option($id, 'mailtpl_opts', array('from_email' => 'no-reply@'.$blog_details->domain));
update_blog_option($id, 'woocommerce_email_from_address', 'no-reply@'.$blog_details->domain );

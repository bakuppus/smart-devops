...
if (!class_exists('OneAcademy_Settings')):
    ...
    class OneAcademy_Settings {
        ...
        function admin_menu() {
            add_menu_page(_('OneAcademy'), _('OneAcademy'), 'manage_woocommerce', 'oneacademy', '__return_false', 'dashicons-welcome-learn-more', 58);
            $page_hook = add_submenu_page('oneacademy', 'Oneacademy Courses', _('OneAcademy Courses'), 'manage_woocommerce', 'oneacademy-courses', array($this, 'oneacademy_courses'));
            ...
            add_submenu_page('oneacademy', 'Settings', 'Settings', 'manage_woocommerce', 'oneacademy-settings', array($this, 'plugin_page'));
        ...
        public function get_settings_fields() {
          $offset = parse_url(get_site_url())['scheme'] == 'http' ? 7 : 8;
            $settings_fields = array(
                'connection_settings' => array(
                    ...
                    array(
                        ...
                        'placeholder' => '',
                        'type' => 'url',
                        'default' => get_option('mdl_site_url', substr(get_site_url(), 0, $offset) . 'lms.' . substr(get_site_url(), $offset)),
                    ...
                    array(
                        ...
                        'placeholder' => '',
                        'type' => 'text',
                        'default' => get_blog_option(get_current_network_id(),'connection_settings') ? get_blog_option(get_current_network_id(),'connection_settings')['mdl_access_token'] : '',
                        'sanitize_callback' => 'sanitize_text_field'
                    ),
                ),
        ...
        public function wsa_form_bottom_sync_enrol() {
            ...
            ?>
            <link rel="stylesheet" href="<?php echo esc_url( plugins_url( 'assets/css/multi-select.dist.css', dirname(__FILE__) ) ); ?>" />
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc">Select Users</th>

                        <td class="forminp forminp-text">
                          <a href='#' id='select-all'><button class="button button-primary">Select All</button></a>
                          <a href='#' id='deselect-all'><button class="button">Deselect All</button></a>

                            <select class="regular-text" multiple="multiple" name="sync_enrol_users" id="sync_enrol_users">
            ...
            <script type="text/javascript">
                jQuery(function ($) {
                  ...
                  $('#select-all').click(function(){
                    $('#sync_enrol_users').multiSelect('select_all');
                    return false;
                  });
                  $('#deselect-all').click(function(){
                    $('#sync_enrol_users').multiSelect('deselect_all');
                    return false;
                  });
            ...
            <script src="<?php echo esc_url( plugins_url( 'assets/js/jquery.quicksearch.js', dirname(__FILE__) ) ); ?>"> </script>
            <script src="<?php echo esc_url( plugins_url( 'assets/js/jquery.multi-select.js', dirname(__FILE__) ) ); ?>"> </script>
            <?php
        }
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <select class="regular-text" name="sync_course_platform" id="sync_course_platform">
                                <option value="wp_to_mdl">Store to LMS</option>
                                <option value="mdl_to_wp">LMS to Store</option>
                            </select>
                        </td>
                    </tr>
                    <tr valign="top">
